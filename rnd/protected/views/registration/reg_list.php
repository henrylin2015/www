<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo $this->createUrl("registration/index");?>">Registration</a>
		</li>
	</ul>
</div>
<!-- END PAGE HEADER-->
			...
			<div class="modal-body">
				<form action="<?php echo $this->createUrl("common/saveUserMylist");?>" class="form-horizontal" method="post">
					<div class="form-group">
						...
						<input type="hidden" name="module_type" value="mrd_reg"/>
	...
	$(function (){
		...
		//dataTable checked
         $("#addToList").click(function() {
           	var tableArr = dataTableCheck("#reg_tables","input.checkboxes");
...
<script>
	$(function(){
		...
		var url = <?php echo "'".$this->createUrl('registration/jsonregistration_index')."'";?>;
