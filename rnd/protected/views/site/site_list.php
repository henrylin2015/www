...
<!--
<div class="row">
<form action="<?php echo $this->createUrl('site/index');?>" class="form-horizontal form-row-seperated" id="site_submit">
		<div class="search-mrd">
			<div class="col-md-11">
				<div class="input-group">
					<div class="input-cont">
						<input type="text" placeholder="Find site..." name="search_site" class="form-control"></div>
			...
			<div class="portlet-body form">
				<div class="form-body">
					<div class="form-group">
						<label class="control-label col-md-3"><?php echo Yii::t('site', 'f_Therapeutic_area'); ?>:</label>
						<div class="col-md-9">
							<div class="input-group">
					...
					<div class="form-group">
						<label class="control-label col-md-3"><?php echo Yii::t('site', 'f_Region'); ?>:</label>
						<div class="col-md-9">
							<div class="input-group">
								<div class="icheck-inline">
									<label>
					...
					<div class="form-group">
						<label class="control-label col-md-3"><?php echo Yii::t('site', 'f_City_level'); ?>:</label>
						<div class="col-md-9">
							<div class="input-group">
								<div class="icheck-inline">
									<label>
