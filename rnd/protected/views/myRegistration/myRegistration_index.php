...
<div class="row">
	...
	<div class="col-md-2 col-sm-3">
		<div class="dashboard-stat dashboard_list purple-plum">
			<div class="details details_position">
				<a href="<?php echo $this->createUrl("myRegistration/list",array("type"=>'module'));?>">
					<div class="number">HMPL Registration</div>
				</a>
			</div>
			<a class="more" href="<?php echo $this->createUrl("myRegistration/list",array("type"=>'module'));?>">
				...
				<form action="<?php echo $this->createUrl("common/updataByIdUserList");?>" method="post" class="form-horizontal" role="form">
					<div class="number" style="padding-top:0;position: relative;">
						<div class="form-body">
							<div class="form-group form-md-line-input">
								<div class="col-md-12">
									...
									<input type="hidden" name="controller" value="myRegistration"/>
						...
						<div class="" style="position: absolute;right: 5px;bottom: 10px;">
							...
							array("mrd_id"=>$va->mylist_id,"controller"=>'myRegistration',"action"=>"index","module_type"=>'mrd_reg'));?>" title="Delete" alt="Delete" ><i class="fa fa-trash-o"></i></a>
						</div>
					</div>
				</form>
			</div>
			<a class="more" href="<?php echo $this->createUrl("myRegistration/list",array("type"=>'myModule',"myId"=>$va->mylist_id));?>">
	...
	<div class="col-md-2 col-sm-3 addList">
		<div class="dashboard-stat dashboard_list blue-madison">
			<a href="<?php echo $this->createUrl("registration/index")?>" class="" title="Create new pharma">
