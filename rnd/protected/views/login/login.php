...
<div class="content">
	<!-- BEGIN LOGIN FORM -->
	<form class="login-form" id="login-form" onsubmit="return mySubmit(true)" action="<?php echo $this->createUrl("login/getpassword");?>" method="post">
		<div class="form-title" style="margin-bottom:0;">
			<!-- <span class="form-title">Welcome to</span> -->
			<span class="form-subtitle" style="padding-left:0;">Password sent successfully.</span>
		</div>
		<div class="form-title">
			<!-- <span class="form-title">Welcome to</span> -->
			<span class="form-subtitle" style="padding-left:0;">Please check your email and enter session password below.</span>
		</div>
		<div class="alert alert-danger display-hide">
			<button class="close" data-close="alert"></button>
			<span>Password require.</span>
		</div>
		<?php
		...
		<div class="form-group">
			...
			<input class="form-control form-control-solid placeholder-no-fix" value="<?php echo $_email;?>" readonly="true" type="text" autocomplete="off" placeholder="User email" name="UserEmail"/>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<div class="input-group">
				<div class="icheck-list">
					<label class="">
						<input type="checkbox" class="icheck" id="agree" name="agreeName" value="agree" style="position: absolute; opacity: 0;">
						<span style="color: #fff;">I agree with Modular R&D online database</span> 
					</label>
				</div>
			</div>
		</div>
...
jQuery(document).ready(function() { 
    ...
    $("#login-form").submit(function(){
        ...
        if(agree != "checked"){
            alert("You must agree with our terms and conditions to view our research.");
