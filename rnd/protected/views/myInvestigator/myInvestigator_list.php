<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo $this->createUrl("myInvestigator/index");?>">My Investigator</a> <i class="fa fa-angle-right"></i>
		</li>
		<li>
...
<script>
	$(function(){
		...
		?>
			var url=<?php echo "'".$this->createUrl('myInvestigator/AjaxList',array("type"=>'module'))."'";?>;
		<?php
			}else if(!empty($_REQUEST['type']) && $_REQUEST['type']=="myModule" && !empty($_REQUEST['myId'])){
		?>
			var url=<?php echo "'".$this->createUrl('myInvestigator/AjaxList',array('type'=>'myModule','myId'=>$_REQUEST['myId']))."'";?>;
		<?php
			}
		?>
