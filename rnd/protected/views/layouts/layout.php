...
<!--table export-->
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/public/tableExport/tableExport.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/public/tableExport/jquery.base64.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/public/tableExport/jspdf/libs/sprintf.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/public/tableExport/jspdf/jspdf.js" charset="utf-8"></script>
<script type="text/javascript" src="<?php echo Yii::app()->request->baseUrl;?>/public/tableExport/jspdf/libs/base64.js" charset="utf-8"></script>
<!--end table export-->
...
<script src="<?php echo Yii::app()->request->baseUrl;?>/public/admin/pages/scripts/dateTablesAjax.js"></script>
<?php
                ...
                <li>
                    <a href="#">
                        ...
                        <span class="badge badge-my badge-default" style="background-color: #F3565D;width: 20px;">
                            <?php echo Yii::app()->request->cookies['mrd_drug']->value;?></span>
                        <?php
                                    }
                                ?>
                        <i class="icon-docs"></i>           
